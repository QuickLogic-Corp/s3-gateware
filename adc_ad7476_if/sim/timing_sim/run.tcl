...
vlog -work work +define+GSIM fifo_controller.sim.v
vlog -work work +define+GSIM ram.sim.v
vlog -work work +define+GSIM ramfifo.sim.v
vlog -work work +define+GSIM assp_bfm.sim.v
