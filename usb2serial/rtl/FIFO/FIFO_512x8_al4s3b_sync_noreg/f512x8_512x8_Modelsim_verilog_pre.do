#------------------------------------------------------------------------------
#- File            :f512x8_512x8_modelsim_verilog_pre.do
#- Design          : FIFO
...
# compile FIFO design and testbench files
vlog -work work C:/QuickLogic/QuickWorks_2016.2_Release/spde/data/PolarPro-III/AL4S3B/ram8k_2x1_cell.v
vlog -work work C:/QuickLogic/QuickWorks_2016.2_Release/spde/data/PolarPro-III/AL4S3B/rrw/fifo_blk.v
vlog -work work f512x8_512x8.v
vlog -work work f512x8_512x8.tf
...
run -all
write transcript f512x8_512x8_modelsim_verilog_pre_log.doc
