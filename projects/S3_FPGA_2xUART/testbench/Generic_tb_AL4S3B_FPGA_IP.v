...
top     u_AL4S3B_FPGA_Top 
    ...
    .UART1_SIN_i               ( Null_Modem_Tx_to_Rx1                      ),
    .UART1_SOUT_o              ( Null_Modem_Rx_to_Tx1                      )
    //.SIN                       ( Null_Modem_Tx_to_Rx                       ),
    //.SOUT                      ( Null_Modem_Rx_to_Tx                       )
...
Serial_Tx_gen_bfm             #(
    ...
    u_Serial_Tx1_gen_bfm        (

    .Tx                        ( Null_Modem_Tx_to_Rx1                    ),
    .RTSn                      (                                         ),
    .CTSn                      (                                         )
...
Serial_Rx_monitor             #(
    ...
    u_Serial_Rx1_monitor                (

    .Rx                                ( Null_Modem_Rx_to_Tx1              ),
    .RTSn                              (                                   ),
    .CTSn                              (                                   ),
    ...
    .Rx_Holding_Reg_Stop_Bit           ( Rx_Holding_Reg_Stop_Bit1           ),
    .Rx_Holding_Reg_Parity_Bit         ( Rx_Holding_Reg_Parity_Bit1         ),
    .Rx_Holding_Reg_Data_Bit           ( Rx_Holding_Reg_Data_Bit1           ),
    .Rx_Holding_Reg_Start_Bit          ( Rx_Holding_Reg_Start_Bit1          ),
    .Rx_Holding_Reg_Parity_Error_Flag  ( Rx_Holding_Reg_Parity_Error_Flag1  ),
    .Rx_Holding_Reg_Framing_Error_Flag ( Rx_Holding_Reg_Framing_Error_Flag1 ),
    .Rx_Holding_Reg_Break_Flag         ( Rx_Holding_Reg_Break_Flag1         ),
    .Rx_Holding_Reg_False_Start_Flag   ( Rx_Holding_Reg_False_Start_Flag1   )
